...
listLyThuyeDoThiPost.push(new Post("Dijsktra - Thuật toán tìm đường đi ngắn nhất", "post/lythuyetdothi/Dijsktra.html", "Admin", "13-11-2017"));
listLyThuyeDoThiPost.push(new Post("Floyd - Tìm đường đi ngắn nhất", "post/lythuyetdothi/Floyd.html", "Admin", "13-11-2017"));
listLyThuyeDoThiPost.push(new Post("Bellman - ford Tìm đường đi ngắn nhất", "post/lythuyetdothi/Bellman.html", "Admin", "13-11-2017"));
listLyThuyeDoThiPost.push(new Post("Floyd warshall - tìm đường đi ngắn nhất", "post/lythuyetdothi/Warshall.html", "Admin", "13-11-2017"));
...
// atomat
listAtomatPost.push(new Post("Khái niệm ngôn ngữ hình thức", "post/atomat/KhaiNiem.html", "Admin", "13-11-2017"));
listAtomatPost.push(new Post("Văn phạm", "post/atomat/VanPham.html", "Admin", "13-11-2017"));
listAtomatPost.push(new Post("Biểu thức chính quy (Regular Expression", "post/atomat/BieuThucChinhQuy.html", "Admin", "13-11-2017"));
listAtomatPost.push(new Post("Atomat hữu hạn đơn định và không đơn định", "post/atomat/AtomatHuuHan.html", "Admin", "13-11-2017"));
listAtomatPost.push(new Post("Đơn định hóa Atomat", "post/atomat/DonDinhHoa.html", "Admin", "13-11-2017"));
listAtomatPost.push(new Post("Chuẩn hóa một văn phạm phi ngữ cảnh", "post/atomat/ChuanHoaVanPhamPhiNguCanh.html", "Admin", "13-11-2017"));
